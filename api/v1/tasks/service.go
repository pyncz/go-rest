...
func CreateService[
	...
	collectionName string,
	keyField string,
) *Service[T, TFilters, TKeyValue] {
	return &Service[T, TFilters, TKeyValue]{
		Env:            env,
...
func (s *Service[T, TFilters, _]) Read(
	filters *TFilters,
...
func (s *Service[T, TFilters, _]) ReadPaginated(
	filters *TFilters,
...
func (s *Service[T, TFilters, TKeyValue]) FindByKey(
	key TKeyValue,
) (*T, error) {
	c := s.collection()
